...
namespace Cognex.VS.Utility
{
    ...
    public class FormSetPasswords : System.Windows.Forms.Form
    {
        ...
        private AccessLevel mAccessLevel = AccessLevel.Operator;
        private TextBox txtCurrentPassword;
        private Label label1;
        private string mExpectedPassword = "";
        public FormSetPasswords(PasswordFile file,AccessLevel accessLevel, string pass)
        {
            //
        ...
        private void InitializeComponent()
        {
            ...
            this.groupBox_Supervisor.Location = new System.Drawing.Point(16, 40);
            this.groupBox_Supervisor.Name = "groupBox_Supervisor";
            this.groupBox_Supervisor.Size = new System.Drawing.Size(400, 88);
            ...
            this.groupBox_Administrator.Location = new System.Drawing.Point(16, 150);
            this.groupBox_Administrator.Name = "groupBox_Administrator";
            this.groupBox_Administrator.Size = new System.Drawing.Size(400, 98);
            ...
            // txtCurrentPassword
            // 
            this.txtCurrentPassword.Location = new System.Drawing.Point(168, 14);
            this.txtCurrentPassword.Name = "txtCurrentPassword";
            this.txtCurrentPassword.PasswordChar = '●';
            this.txtCurrentPassword.Size = new System.Drawing.Size(224, 20);
            this.txtCurrentPassword.TabIndex = 2;
            this.txtCurrentPassword.Text = "textBox1";
            // 
            // label1
            // 
        ...
        {
            if (mAccessLevel > AccessLevel.Operator)
            {
                if (txtCurrentPassword.Text == mExpectedPassword)
                {
                    ...
                    MessageLoggerManager.Log.Info("[Action] Password changed!");
                }
                else
                {
                    MessageBox.Show("Current Password is not correct!", "Warning",MessageBoxButtons.OK,MessageBoxIcon.Warning);
                }
            }
            else
            {
                MessageBox.Show("Operator cannot change Password!", "Warning", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
